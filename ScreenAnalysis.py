...
# Use following drivers with selenium, without a driver it won't work -> https://chocolatey.org/packages/selenium-all-drivers
# Multiple drivers can be used, just set up more and take the pics with different ones.
# To use manually, comment out the capture function call, and put images into the screenshot dir with the correct names.
# Take out headless options to see the magic happen with your own eyes.

class ScreenAnalysis:

    STAGING_URL = 'https://www.uni-miskolc.hu/'
    PRODUCTION_URL = 'https://www.uni-miskolc.hu/'
    options = None
    driver = None
    ...
    def __init__(self):
        ...
        self.set_up()
        self.capture_screens() # comment this to use manually
        self.analyze()
        self.clean_up()
    ...
    def screenshot(self, url, file_name):
        ...
        self.driver.save_screenshot(os.path.join('./', 'screenshots', file_name))
